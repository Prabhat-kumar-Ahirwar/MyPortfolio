...
const chipClass =
  "px-4 py-2 rounded-full text-sm bg-[#1e1e1f] border border-[#383838] text-gray-300 hover:border-blue-400/50 transition";
  ...
  return (
    <section id="skills" className="scroll-mt-24">
      ...
      <div className={sectionClass}>
        <h3 className="text-xl font-semibold text-white mb-4">
          ...
          <ul className="flex flex-wrap gap-4">
            {['Database Management Certification', 'NPTEL Certification (IIT)', 'Participation in Hackathons', 'Volunteering Experience'].map(item => (
              <li key={item}>
                <a
                  href="https://drive.google.com/drive/folders/1hupHkMuzoRumq94NRziCwmrEuBhsnb3W?usp=drive_link"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-[#212123] border border-[#383838] px-4 py-2 rounded-full text-blue-400 hover:text-white hover:bg-blue-500/20 text-sm font-medium transition"
                >
                  {item}
                </a>
              </li>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div className={sectionClass}>
  <h3 className="text-xl font-semibold text-white mb-1">Hobbies</h3>
    ...
    {["Video Editing", "Visual Storytelling"].map((hobby) =>
      hobby === "Video Editing" ? (
        <a
          ...
          className={
            chipClass +
            " text-blue-400 hover:text-white hover:bg-blue-500/20 transition"
          }
        >
          {hobby}
        </a>
